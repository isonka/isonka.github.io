        ...
        <div className="contact-container">
          <div className="contact-info">
            ...
            <div className="contact-links">
              <a href="tel:+31685162693" className="contact-link" onClick={() => trackPhoneClick()}>
              ...
              <a href="https://wa.me/31685162693" target="_blank" rel="noopener noreferrer" className="contact-link whatsapp-link" onClick={() => trackSocialClick('whatsapp')}>
                <svg className="contact-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <a href="mailto:info@ptstudio7amsterdam.nl" className="contact-link" onClick={() => trackEmailClick()}>
                <svg className="contact-icon" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
