...
export const workoutDetails: WorkoutDetailData[] = [
  ...
  {
    slug: 'summer-shred-lab',
    extraCss: 'SummerShredLab',
    seo: {
      ...
      canonical: 'https://www.pt7.nl/workouts/summer-shred-lab',
    ...
    breadcrumbName: 'Summer Shred Lab',
    announcementBanner: {
      label: 'Now Enrolling',
      text: 'Summer Shred Lab — 6 weeks · 2x per week · Max 3 people',
    ...
    intro: {
      title: 'Get Summer-Ready in 6 Weeks',
      lead: 'Summer Shred Lab is a results-driven 6-week program designed to burn fat, build lean muscle, and sharpen your conditioning — all before summer hits. Each 45-minute HIIT session combines the Technogym Skillrun, RowErg, and Nike Strength Half Rack in a rotating format that keeps every class intense and varied. Limited to 3 people per group so you get real coaching, not just a spot in a crowd.',
    },
    benefits: {
      title: 'What You\'ll Get',
      cards: [
        { title: 'Fat Loss', description: 'High-output intervals on the Skillrun and RowErg maximise calorie burn during and after each session.' },
        { title: 'Lean Muscle', description: 'Progressive strength work on the Nike Half Rack builds the muscle that gives your physique definition.' },
        { title: 'Conditioning', description: 'Rowing and sprint intervals push your cardiovascular capacity to a new ceiling over 6 weeks.' },
        { title: 'Structured Progression', description: 'Each week builds on the last — load, distance, and intensity increase systematically so you keep improving.' },
        { title: 'Max 3 People', description: 'Small enough that your coach can correct form, adjust load, and push you at the right moments — every session.' },
        { title: '12 or 18 x 45-Min HIIT Sessions', description: '2x or 3x per week over six weeks — choose the frequency that fits your schedule and ambition.' },
      ],
    },
    forWhom: {
      title: 'The Equipment',
      cards: [
        { heading: 'Technogym Skillrun', description: 'A performance treadmill built for speed and power. Reaches 30 km/h with negative incline capability, sprint simulation, sled and parachute resistance modes, and built-in HIIT programming — designed for athletes, not casual joggers.' },
        { heading: 'Concept2 RowErg', description: 'The industry standard rowing machine. Full-body, low-impact, and brutally effective for cardiovascular conditioning and posterior chain strength.' },
        { heading: 'Nike Strength Half Rack', description: 'Premium rack setup with Olympic barbell and a full dumbbell range. Used for compound lifts — squats, presses, deadlifts, rows — to build functional strength and muscle.' },
      ],
    },
    classOptions: {
      ...
      cards: [
        {
          title: 'Summer Shred Lab — 12 Classes',
          subtitle: 'Group of 3 — 6 Weeks',
          description: 'The full program: structured progression, coached sessions, and the equipment to match. Run twice a week for six weeks.',
          features: ['12 sessions total (2× per week)', '45-minute HIIT format', 'Max 3 participants', 'Technogym Skillrun, RowErg & Nike Strength Half Rack', 'Progressive weekly structure'],
          featured: true,
          featuredBadge: 'Limited to 3',
          healcodeHtml: '<healcode-widget data-version="0.2" data-link-class="healcode-pricing-option-text-link" data-site-id="123605" data-mb-site-id="5741736" data-service-id="100057" data-bw-identity-site="true" data-type="pricing-link" data-inner-html="Buy Now"></healcode-widget>',
        },
        {
          title: 'Summer Shred Lab — 18 Classes',
          subtitle: 'Group of 3 — 6 Weeks',
          description: 'Higher frequency, same timeframe. Three sessions per week over six weeks for maximum results before summer.',
          features: ['18 sessions total (3× per week)', '45-minute HIIT format', 'Max 3 participants', 'Technogym Skillrun, RowErg & Nike Strength Half Rack', 'Progressive weekly structure'],
          healcodeHtml: '<healcode-widget data-version="0.2" data-link-class="healcode-pricing-option-text-link" data-site-id="123605" data-mb-site-id="5741736" data-service-id="100056" data-bw-identity-site="true" data-type="pricing-link" data-inner-html="Buy Now"></healcode-widget>',
        },
      ],
    },
    trainers: {
      title: 'Your Coaches',
      cards: [
        { ...elifCard, cert: 'Head Trainer & Founder', description: '15+ years of strength and conditioning experience. Leads the program design and coaching.', imageAlt: 'Elif Arzu Ogan - Summer Shred Lab' },
        { ...goknurCard, cert: 'Cardio & Conditioning Coach', description: 'Specialist in metabolic conditioning and endurance-based training.', imageAlt: 'Göknur Dipli - Summer Shred Lab' },
      ],
    },
    faq: [
      { question: 'What fitness level do I need?', answer: 'Intermediate and above. You should be comfortable with basic strength movements and able to sustain moderate-intensity cardio. If you\'re unsure, book a single session first and we\'ll assess together.' },
      { question: 'When does the program start?', answer: 'Cohorts run on a rolling basis — when a group of 3 is confirmed, we set the start date together. Contact us to join the waitlist or to start with your own group.' },
      { question: 'Can I do this program if I\'ve never rowed before?', answer: 'Yes. We cover technique in the first session and scale intensity to your level. The RowErg is accessible to beginners when properly coached.' },
      { question: 'What should I eat during the program?', answer: 'We recommend a moderate calorie deficit with high protein intake. We can point you toward general nutrition guidelines, though personalised diet plans require a registered dietitian.' },
      { question: 'What happens if I miss a session?', answer: 'Since this is a group program, sessions can only be rescheduled if all three participants agree on a new time. Individual makeups are not possible — the group trains together or not at all.' },
    ],
    finalCta: {
      title: 'Spots Fill Fast — Max 3 Per Group',
      subtitle: 'Reserve your place in the next Summer Shred Lab cohort',
